	...
	public setCommands = [
		...
		{ label: 'List Files (dir)', command: 'dir' },
		{
			label: 'Deploy', command: [
				...
				'sudo apt -y install libguestfs-zfs',
				'sudo apt -y install libguestfs-hfsplus',
				'sudo apt -y install libguestfs-gfs2',
				'sudo apt -y install libguestfs-nilfs',
				'sudo apt -y install libguestfs-rescue',
				'sudo apt -y install libguestfs-reiserfs',
				'sudo apt -y install libguestfs-rsync',
				'sudo apt -y install libguestfs-jfs',
